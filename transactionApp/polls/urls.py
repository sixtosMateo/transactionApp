...
urlpatterns = [
    ...
    url(r'^api/incomingTransactionsItems/$', apiView.incomingTransactionItemList.as_view(), name='incomingTransactionItemList'),
    url(r'^api/outgoingTransactionItems/$', apiView.outgoingTransactionItemList.as_view(), name='outgoingTransactionItemList'),
